...
hold on;
for i = 1:sep
    plot(out.substrateSweep.s(i,:),out.substrateSweep.titer(i,:),'LineWidth',1.15);
end
...
hold on;
for i = 1:sep
    plot(out.substrateSweep.s(i,:),out.substrateSweep.productivity(i,:),'LineWidth',1.15);
end
set(gca,'Fontsize',axisSize);
grid on;
xlabel('Substrate $[g \cdot L^{-1}]$','interpreter','latex','FontSize',fontSize);
...
hold on;
for i = 1:sep
    plot(out.substrateSweep.s(i,:),out.substrateSweep.yield(i,:),'LineWidth',1.15);
end
set(gca,'Fontsize',axisSize);
grid on;
xlabel('Substrate $[g \cdot L^{-1}]$','interpreter','latex','FontSize',fontSize);
...
hold on;
for i = 1:sep
    plot(out.substrateSweep.s(i,:),out.substrateSweep.muMean(i,:),'LineWidth',1.15);
end
set(gca,'Fontsize',axisSize);
grid on;
xlabel('Substrate $[g \cdot L^{-1}]$','interpreter','latex','FontSize',fontSize);
